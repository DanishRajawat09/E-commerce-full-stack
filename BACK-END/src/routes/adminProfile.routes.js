...
import { createProfile, updateShopName } from "../controllers/adminProfile.controller.js";
...
router.route("/update/shop-name").patch(verifyJwtAdmin , isAdmin , updateShopName)
