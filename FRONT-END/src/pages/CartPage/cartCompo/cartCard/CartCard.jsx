...
import { cartData } from '../../../../api/HomePageProducts'
...
useEffect(() => {
    ...
    return cartProduct.length > 0 ? (
        <>
            {cartProduct.map(({ crtProdId, crtProdTitle, crtProdImg, crtProdQuantity, crtProdSize, crtProdPrice }) => (
                ...
                <div key={crtProdId} className='cartCard grid'>
                    ...
                    <div className="cardData">
                        <div className="titleArea flexContainer">
                            ...
                            <img src="/cartBin.png" alt="bin" onClick={() => handleRemoveProduct(crtProdId)} />
                        </div>
